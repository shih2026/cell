...
content = content.replace(/const STAGES: TabContent\[\] = \[.*?\];/s, `const STAGES: TabContent[] = [
...
content = content.replace(/const QUIZ_DATA: Record<string, Question\[\]> = \{.*?\};\n\}較大.*?};\n/s, `const QUIZ_DATA: Record<string, Question[]> = {
