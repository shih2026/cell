...
function P11ObserveSummary({ unlockNext }: { unlockNext: () => void }) {
  return (
    <StageWrapper 
      title="觀察總結" 
      subtitle="細胞構造的推論與比較"
      metaphor={{ icon: '💡', title: '見微知著', desc: '看不見不代表不存在，科學需要觀察結合邏輯推理。' }}
...
const insertIndex = content.indexOf('function P11FinalGame');
content = content.slice(0, insertIndex) + p11Code + '\n' + content.slice(insertIndex);
