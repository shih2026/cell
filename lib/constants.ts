...
export const CHALLENGE_QUESTIONS = [
  ...
  {
    q: "使用複式顯微鏡觀察細胞時，下列操作方式何者正確？",
    options: [
      "先用高倍鏡尋找目標，再換低倍鏡；先調細調節輪，再調粗調節輪",
      "先用低倍鏡尋找目標，再換高倍鏡；先調細調節輪，再調粗調節輪",
      "先用低倍鏡尋找目標，再換高倍鏡；先調粗調節輪，再調細調節輪",
      "在高倍鏡下觀察時，若影像模糊應先轉動粗調節輪調整",
    ],
    correct: 2,
    hint: "顯微鏡操作應先用低倍鏡找到目標，再換高倍；調整焦距應先用粗調節輪找到焦距，再換成細調節輪微調。且高倍鏡下不可動粗調節輪。",
    img: "05_載玻片.png",
  },
  {
